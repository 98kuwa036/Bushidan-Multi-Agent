...
| コンポーネント | 最小 | 推奨 |
|---------------|------|------|
| **CPU** | i5-8500 (6C/6T) | i5-9500/i7-8700 (6C/6T~12T) |
...
### HP ProDesk 600 (i5-8500, 32GB RAM)

| テスト | 結果 |
|-------|------|
| 初回ロード時間 | 約50秒 |
| 短いプロンプト (100 tokens) | 14-18 tok/s |
| 長いプロンプト (2000 tokens) | 10-14 tok/s |
| ピークRAM使用量 | 約19GB |
| 平均CPU使用率 | 85-95% |
